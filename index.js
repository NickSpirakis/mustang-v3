...
function saveContactsToServer() {
  ...
  console.log("Contact array after save");
  console.log(contactArray);
}
...
function loadIndexAndContacts() {
  ...
  indexRequest.onload = function() {
      ...
      for (i=0; i<contactIndex.length; i++) {
          urlcont.push(contactIndex[i].ContactURL);
      }
      console.log("urlcont: " + JSON.stringify(urlcont));
      loadContacts();
  }
  indexRequest.send();
}
...
function loadContacts() {
  ...
  if (urlcont.length > loadingContact) {
      loadNextContact(urlcont[loadingContact]);
  }
}
...
function loadNextContact(URL) {
  ...
  contactRequest.onload = function() {
      ...
      if (urlcont.length > loadingContact) {
          ...
          document.getElementById("statusID").innerHTML = "Contacts Loaded (" + urlcont.length + ")";
          viewCurrentContact()
